--CREATE TABLES  
  ...
  "createdAt" DATE,
  "updatedAt" DATE,
  CONSTRAINT "FK_announ_read_student.id_announce"
    FOREIGN KEY ("id_announce")
      REFERENCES "announcements"("id"),
  CONSTRAINT "FK_announ_read_student.id_student"
  ...
  CREATE TABLE "announ_read_person" (
    ...
    "createdAt" DATE,
    "updatedAt" DATE,
    CONSTRAINT "FK_announ_read_person.id_announce"
      FOREIGN KEY ("id_announce")
        REFERENCES "announcements"("id"),
    CONSTRAINT "FK_announ_read_person.id_person"
      FOREIGN KEY ("id_person")
        REFERENCES "persons"("id")
  );
