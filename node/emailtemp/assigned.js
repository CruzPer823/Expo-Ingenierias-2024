export default function generateAssignedTemplate({ nombreProfesor, tituloProyecto }) {
    return `
      <!DOCTYPE html>
      <html lang="es">
      <head>
                  ...
                  <tr>
                      ...
                      >
                          <div class="main">
                              ...
                              <h1>Notificación de Proyecto Asignado</h1>
  
                              <p>Hola ${nombreProfesor},</p>
                              <p>Un estudiante te ha registrado como profesor/ra asesor/ra de su proyecto: <strong>${tituloProyecto}</strong>.</p>
                              <p>Ingresa a tu perfil para ver más detalles del proyecto o si no cuentas con un perfil puedes registrarte en el siguiente enlace:<br> <a href="http://localhost">localhost</a></p>
