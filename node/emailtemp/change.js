export default function generateChangeTemplate({ nombreProfesor, tituloProyecto }) {
    return `
      <!DOCTYPE html>
      <html lang="es">
      <head>
                  ...
                  <tr>
                      ...
                      >
                          <div class="main">
                              ...
                              <h1>Notificación de Proyecto Actualizado</h1>
  
                              <p>Hola ${nombreProfesor},</p>
                              <p>El proyecto <strong>${tituloProyecto}</strong> ha sido actualizado por el líder del proyecto.</p>
                              <p>Ingresa a tu cuenta para realizar la evaluación nuevamente en el siguiente enlace:<br> <a href="http://localhost">localhost</a></p>
